...
void Input::imageSyncCallback(const sensor_msgs::ImageConstPtr &imgL,
  ...
  cv::resize(imageLeft_t1, imageLeft_t1,
             cv::Size(imageLeft_t1.cols, imageLeft_t1.rows));
  cv::resize(imageRight_t1, imageRight_t1,
             cv::Size(imageRight_t1.cols, imageRight_t1.rows));
...
void Input::run() {
  ...
  if (pointsLeft_t0.size() > 0) {
    ...
    // std::cout << "projMatrl" << std::endl << projMatrl.type() << std::endl;
    // std::cout << "projMatrr" << std::endl << projMatrr.type() << std::endl;
    // std::cout << "pointsLeft_t0" << std::endl << pointsLeft_t0 << std::endl;
    // std::cout << "pointsRight_t0" << std::endl << pointsRight_t0 <<
    // std::endl; std::cout << "points4D_t0" << std::endl << points4D_t0.type()
    // << std::endl;
    cv::triangulatePoints(projMatrl, projMatrr, pointsLeft_t0, pointsRight_t0,
                          points4D_t0);
    cv::convertPointsFromHomogeneous(points4D_t0.t(), points3D_t0);
    ...
    // std::cout << "projMatrl" << std::endl << projMatrl.type() << std::endl;
    // std::cout << "projMatrr" << std::endl << projMatrr.type() << std::endl;
    // std::cout << "pointsLeft_t1" << std::endl << pointsLeft_t1 << std::endl;
    // std::cout << "pointsRight_t1" << std::endl << pointsRight_t1 <<
    // std::endl; std::cout << "points4D_t1" << std::endl << points4D_t1.type()
    // << std::endl;
    cv::triangulatePoints(projMatrl, projMatrr, pointsLeft_t1, pointsRight_t1,
                          points4D_t1);
    cv::convertPointsFromHomogeneous(points4D_t1.t(), points3D_t1);
